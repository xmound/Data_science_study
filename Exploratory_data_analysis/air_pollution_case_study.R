...
setwd("/Users/daili/Desktop/personal folder/git/Data_Science/Exploratory_data_analysis/data/pm25_data")
...
mean(negative, na.rm = T) # about 2% in the data, so probably ignore these data at this moment
dates <- pm1$Date
str(dates)
